...
# and 与
# and 两边的数据必须全部都是true的时候 才会返回true 只要有一端返回的是false 那么就返回false
# and两端都是false的时候 返回的是false
print(10 >= 20 and 10 > 11)
# and一端是true 一端是false 一端返回的是true 返回的是false
print(10 > 5 and 10 > 11)
# and 一端返回的是false 一端返回的是true 返回的是false
print(10 > 11 and 10 > 5)
# and 两端返回的都是true则返回的是true
print(10 > 5 and 10 > 6)
